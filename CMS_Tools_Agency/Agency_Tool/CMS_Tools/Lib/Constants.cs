...
namespace CMS_Tools.Lib
{
    ...
    {
        public static int ID_DAILY = int.Parse(WebConfigurationManager.AppSettings["ID_DAILY"]);
        public const int TIME_REQUEST = 5000;
        ...
        public enum REQUEST_AGENCY_TYPE: int
        {
            ...
            GET_INFO_AGENCY,
            CHANGE_PASSWORD,
            CHANGE_TRANSACTION_LIMIT,
            FIND_AGENCY,
            TRANFER_MONEY_TO_AGENCY,
            FIND_GAME_ACCOUNT,
            TRANFER_MONEY_TO_AGENCY_USER,
            ACTIVE_PHONE_AGENCY,
            CREATE_AGENCY_SUB2,
            CHANGE_PHONE_AGENCY,
            CHANGE_INFOMATION_AGENCY,
