<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_agency_sub2.aspx.cs" Inherits="CMS_Tools.Test_agency_sub2" %>
                            ...
                            if (data.status == 0) {
                                ...
                                for (var i = 0; i < data.data.length; i++) {
                                    ...
                                    $('#tbl_datatable tbody').append("<tr>" +
                                        ...
                                        "<td>" + obj[25] + "</td>" +
                                        "<td>" + linkLock +
                                        "<a class='btn btn-xs blue btn-circle btn-outline' href='Page.aspx?m=38&agencyid=" + base64Str + "' target='_blank'> Lịch sử giao dịch</a></td > " +
                                        "</tr>");
                                }
