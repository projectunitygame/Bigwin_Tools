<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_ChiPhiChuyenTien.aspx.cs" Inherits="CMS_Tools.Test_ChiPhiChuyenTien" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="col-md-6" style="margin-bottom: 10px;">
                                <label class="control-label label-balance">Chi phí giao dịch</label>
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 0) {
                                ...
                                $.each(data.data, function (i, obj) {
                                    totalDiscount += parseInt(replaceAll(obj[4], ',', ''));
                                    totalAmount += parseInt(replaceAll(obj[3], ',', ''));
                                });
