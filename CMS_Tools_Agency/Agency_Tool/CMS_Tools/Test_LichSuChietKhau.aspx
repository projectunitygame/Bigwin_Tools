<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test_LichSuChietKhau.aspx.cs" Inherits="CMS_Tools.Test_LichSuChietKhau" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="col-md-6" style="margin-bottom: 10px;">
                                <label class="control-label label-balance">Chiết khấu hoàn lại</label>
                                <div class="input-group" style="width:100%">
                                    <input class="form-control content-total-money" id="discountTotal" disabled />
                                </div>
 
                            </div>
                            <div class="col-md-6" style="margin-bottom: 10px;">
                                <label class="control-label label-balance">Tổng tiền giao dịch</label>
                                <div class="input-group" style="width:100%">
                                    <input class="form-control content-total-money style-2" id="amountTotal" disabled />
                                </div>
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 0) {
                                ...
                                $.each(data.data, function (i, obj) {
                                    totalDiscount += parseInt(replaceAll(obj[2],',', '')) ;
                                    totalAmount += parseInt(replaceAll(obj[6], ',', '')) ;
                                });
                                $('#discountTotal').val(formatMoney(totalDiscount) + "đ");
                                $('#amountTotal').val(formatMoney(totalAmount)+"đ");
